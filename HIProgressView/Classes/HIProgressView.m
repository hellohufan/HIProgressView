...
- (void)commonInit {
    ...
    _mode = HIProgressViewModeIndeterminate;
    _margin = 20.0f;
...
- (void)updateIndicators {
    ...
    if (mode == HIProgressViewModeIndeterminate) {
    ...
    else if (mode == HIProgressViewModeDeterminate || mode == HIProgressViewModeAnnularDeterminate) {
        if (!isRoundIndicator) {
        ...
        if (mode == HIProgressViewModeAnnularDeterminate) {
